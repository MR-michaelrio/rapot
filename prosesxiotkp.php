...
if( !isset( $_POST['nama'] ) )
{
    header('location:inputxitokp.php');
    exit();
}
...
$sql   = "INSERT INTO xiotkp (nama,nik,tahun,agamap,agamapp,agamak,agamakk,pknp,pknpp,pknk,pknkk,bindop,bindopp,bindok,bindokk,mtkp,mtkpp,mtkk,mtkkk,sjrp,sjrpp,sjrk,sjrkk,bingp
...
if( !$insert )
{
    ...
    header("Location:inputxiotkp.php");
