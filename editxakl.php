...
<td colspan=2 align=center>Simulasi dan Komunikasi Digital</td>
...
<td colspan=2 align=center>Etika Profesi</td>
<td colspan=2 align=center>Aplikasi Pengolahan <br>Angka / Spreadsheet</td>
<td colspan=2 align=center>Akutansi Dasar</td>
<td colspan=2 align=center>Perbankan Dasar</td>
<td colspan=9 align=center rowspan=2>Kegiatan Ekstrakulikuler</td>
...
$result = mysqli_query($conn, "SELECT * FROM xakl WHERE id='" . $_POST["xakl"][$i] . "'");
...
<td><input type="text" name="perbankanp[]" class="txtField" value="<?php echo $row[$i]['perbankanp']; ?>"></td>
<td><input type="text" name="perbankank[]" class="txtField" value="<?php echo $row[$i]['perbankank']; ?>"></td>
