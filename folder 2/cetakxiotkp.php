...
<body>
	...
	?>
		...
		$nik = $_GET['nik'];
		$no = 0;
		$sql = mysqli_query($koneksi,"SELECT * FROM xiotkp WHERE nik = '$nik'");
		while($rows = mysqli_fetch_array($sql)){
			$no++;
			echo"
			<center>
			<table width=1000px class=wow>
<tr>
<td colspan=2 align=center><img class=cktc src=tc.png width=180px></td>
...
<td colspan=3><img src=latar/garis.PNG width=1800px height=5px></td>
		  ...
		  <td align=center><b>Predikat</b></td>
			...
			<tr>
			<td colspan=8><b>&nbsp;C. Muatan Permintaan Kejuruan</b></td>
			</tr>
			<tr>
			<td colspan=8><b>&nbsp;C3. Kompentensi Keahlian</b></td>
			<tr>
			<td align=center>1</td>
			<td >&nbsp;Otomatisasi Tata Kelola Kepegawaian</td>
			<td align=center>75</td>
			...
			<tr>
			<td align=center>2</td>
			<td >&nbsp;Otomatisasi Tata Kelola Keuangan</td>
			<td align=center>75</td>
			...
			<tr>
			<td align=center>3</td>
			<td >&nbsp;Otomatisasi Tata Kelola Sarana dan Prasarana</td>
			<td align=center>75</td>
			...
			<tr>
			<td align=center>1</td>
			<td >&nbsp;Otomatisasi Tata Kelola Humas dan Keprotokolan</td>
			<td align=center>75</td>
...
<tr>
<td align=center>3</td>
<td  class=hu align=left>&nbsp;".$rows['eskulc']."</td>
