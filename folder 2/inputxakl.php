...
<form method=post action=prosesxakl.php>
<center>
...
<td colspan=4 align=center>Aplikasi Pengolahan <br>Angka / Spreadsheet</td>
<td colspan=4 align=center>Akutansi Dasar</td>
...
<td><input type=text name=perbankanp[] size=3></td>
<td><input type=text name=perbankanpp[] size=3></td>
<td><input type=text name=perbankank[] size=3></td>
<td><input type=text name=perbankankk[] size=3></td>
...
a{text-decoration: none; font-size: 20px;font-family: sans-serif;padding: 14px 10px}
    ...
    .navi{background: #222; height: 50px; width:351.25%}}
	</style>
	<script>
function w3_open() {
