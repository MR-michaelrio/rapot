...
<div class="w3-teal">
  ...
  <a href=formawalxiotkp.php>LEGER</a>
</div>
...
<td colspan=3 align=center><br><b>LAPORAN HASIL BELAJAR MID SEMESTER</b></td>
		...
		<?php
include("koneksi.php");
$a=mysqli_query($koneksi,"SELECT * FROM xiotkp");
$b=mysqli_num_rows($a);
$no=0;
echo '
<center>
...
while ($rows=mysqli_fetch_array($a)){
    ...
    <td>".$rows['nik']."</td>
    <td>".$rows['tahun']."</td>
    <td><i> <a href='cetakxiotkp.php?nik=".$rows['nik']."'> Cetak </a></i></td>
  <td><i> <a href='deletexiotkp.php?nik=".$rows['nik']."'> Delete </a></i></td>
  </tr>";
