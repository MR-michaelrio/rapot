...
<body>
	...
	header("Content-Disposition: attachment; filename=Cetak Leger XOTKP.xls");
	?>
...
<td colspan=4 align=center>Korespodensi</td>
...
<td><?php echo $row ["ekonomip"]?></td>
<td><?php echo $row ["ekonomipp"]?></td>
<td><?php echo $row ["ekonomik"]?></td>
<td><?php echo $row ["ekonomikk"]?></td>

<td><?php echo $row ["admp"]?></td>
<td><?php echo $row ["admpp"]?></td>
<td><?php echo $row ["admk"]?></td>
<td><?php echo $row ["admkk"]?></td>

<td><?php echo $row ["ipap"]?></td>
<td><?php echo $row ["ipapp"]?></td>
<td><?php echo $row ["ipak"]?></td>
<td><?php echo $row ["ipakk"]?></td>

<td><?php echo $row ["teknologip"]?></td>
<td><?php echo $row ["teknologipp"]?></td>
<td><?php echo $row ["teknologik"]?></td>
<td><?php echo $row ["teknologikk"]?></td>

<td><?php echo $row ["korespop"]?></td>
<td><?php echo $row ["korespopp"]?></td>
<td><?php echo $row ["korespok"]?></td>
<td><?php echo $row ["korespokk"]?></td>

<td><?php echo $row ["arsipp"]?></td>
<td><?php echo $row ["arsippp"]?></td>
<td><?php echo $row ["arsipk"]?></td>
<td><?php echo $row ["arsipkk"]?></td>
