...
if( !isset( $_POST['nama'] ) )
{
    header('location:inputxirpl.php');
    exit();
}
...
$sql   = "INSERT INTO xirpl (nama,nik,tahun,agamap,agamapp,agamak,agamakk,pknp,pknpp,pknk,pknkk,bindop,bindopp,bindok,bindokk,mtkp,mtkpp,mtkk,mtkkk,sjrp,sjrpp,sjrk,sjrkk,bingp
