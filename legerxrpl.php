...
<script language="javascript" src="js/usersxrpl.js" type="text/javascript"></script>
...
<div class="main">
    <h1>LEGER X-RPL</h1>
    <div class="btn-group">
    <a class="button" href=cetaklegerxrpl.php>Print Leger</a>
    <a class="button" href=importexcel/importxrpl.php>Insert Murid</a>
...
<td><input type="checkbox" name="xrpl[]" value="<?php echo $row["id"]; ?>" ></td>
<td><?php echo $row["nama"]; ?></td>
<td><?php echo $row["nis"]; ?></td>
<td><?php echo $row["tahun"]; ?></td>
<td><?php echo" <a href='cetakxrpl.php?nis=".$row['nis']."'> Cetak </a>"?></td>
