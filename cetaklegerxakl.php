...
<body>
	...
	header("Content-Disposition: attachment; filename=Cetak Leger XAKL.xls");
	?>
 
 <?php
require_once "db.php";
$result=mysqli_query($conn,"SELECT * FROM xakl");
...
<td><?php echo $row ["perbankanpp"]?></td>
<td><?php echo $row ["perbankank"]?></td>
<td><?php echo $row ["perbankankk"]?></td>
