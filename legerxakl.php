...
<script language="javascript" src="js/usersxakl.js" type="text/javascript"></script>
...
<td><input type="checkbox" name="xakl[]" value="<?php echo $row["id"]; ?>" ></td>
<td><?php echo $row["nama"]; ?></td>
<td><?php echo $row["nis"]; ?></td>
<td><?php echo $row["tahun"]; ?></td>
<td><?php echo" <a href='cetakxakl.php?nis=".$row['nis']."'> Cetak </a>"?></td>
