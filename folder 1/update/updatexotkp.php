...
include ("koneksi.php");
$nik=$_GET['nik'];
$query="SELECT * FROM xotkp WHERE nik='$nik'";
...
<form method=post action='prosesupdatexotkp.php?id=<?php echo $nik;?>'>
<center>
...
include ("koneksi.php");
$nik=$_GET['nik'];
$query="SELECT * FROM xrpl WHERE nik='$nik'";
$hasil=mysqli_query($koneksi, $query);
$rows=mysqli_fetch_array($hasil);
?>
...
<form method=post action='prosesupdatexrpl.php?id=<?php echo $nik;?>'>
<center>
<table border=0 width=1000px>
<tr>
<td colspan=2 align=center><img src=tc.png width=100px></td>
